...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({ to: "/" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/' }) })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({ to: "/" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/' }) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
__VLS_3.slots.default;
var __VLS_3;
var __VLS_4 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_5 = __VLS_asFunctionalComponent(__VLS_4, new __VLS_4(__assign(__assign({ to: "/courses" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/courses' }) })));
var __VLS_6 = __VLS_5.apply(void 0, __spreadArray([__assign(__assign({ to: "/courses" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/courses' }) })], __VLS_functionalComponentArgsRest(__VLS_5), false));
__VLS_7.slots.default;
var __VLS_7;
var __VLS_8 = {}.RouterLink;
/** @type {[typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ]} */ ;
// @ts-ignore
var __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8(__assign(__assign({ to: "/quizzes" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/quizzes' }) })));
var __VLS_10 = __VLS_9.apply(void 0, __spreadArray([__assign(__assign({ to: "/quizzes" }, { class: "px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition" }), { class: ({ 'bg-gray-100 text-gray-900': __VLS_ctx.$route.path === '/quizzes' }) })], __VLS_functionalComponentArgsRest(__VLS_9), false));
__VLS_11.slots.default;
var __VLS_11;
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "flex items-center" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "text-sm text-gray-600 mr-4" }));
(__VLS_ctx.userEmail);
