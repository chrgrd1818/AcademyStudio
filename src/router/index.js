...
var DashboardView_vue_1 = require("../views/DashboardView.vue");
var CoursesView_vue_1 = require("../views/CoursesView.vue");
var QuizzesView_vue_1 = require("../views/QuizzesView.vue");
var router = (0, vue_router_1.createRouter)({
    ...
    routes: [
        ...
        },
        {
            path: '/courses',
            name: 'courses',
            component: CoursesView_vue_1.default,
            meta: { requiresAuth: true }
        },
        {
            path: '/quizzes',
            name: 'quizzes',
            component: QuizzesView_vue_1.default,
            meta: { requiresAuth: true }
        }
    ]
});
